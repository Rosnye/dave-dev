    ...
    return (
        <div className="rounded-xl flex flex-col my-6 p-6">
            <div className="flex p-4 justify-evenly border-gray-300 rounded-xl bg-gray-500 border-b border-w-">
                <div className="h-32 w-32 bg-white flex items-center justify-center border border-white rounded-xl"><img src="./images/Foto_perfil.jpg" 
            ...
            <div className="border-b border-gray-300 w-full p-6 flex flex-col bg-gray-500 rounded-xl mt-2">
                ...
                <div className="h-14 flex justify-evenly items-center mt-8 text-white">
                    <div className="h-10 mr-4 flex items-center"><img className="h-12 mr-4 bg-slate-800 rounded p-2" src="./assets/html-5.svg" alt="html icon"/> HTML</div>
                    <div className="h-10 mr-4 flex items-center"><img className="h-12 mr-4 bg-slate-800 rounded p-2" src="./assets/css-3.svg" alt="css icon"/>CSS</div>
